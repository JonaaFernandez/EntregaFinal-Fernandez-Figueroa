<template>
    <div class="contenedor-grande">
        ...
        <div class="col-sm-12  col-md-12 col-lg-12  d-flex p-2 bd-highlight">
            <h1 class="border-groove text-center mx-auto display-3 p-2">{{titulo}}</h1>
        </div>
        ...
        <!-- FIN CARROUSEL -->
           <!-- COMIENZA SECCION DE NOTICIAS Y LINKS A MEJORES TEMAS TEMAS  -->
           <div class="fondo-editado">

            <article class="mt-3 p-3 border-groove ">
                <h2>Próximos eventos</h2>
                <p>Por conocimiento publico se han suspendido las fechas previstas hasta proximo aviso.</p>
            </article>


            <section class="topSongs margin-top col-lg-12">
    ...
    <!-- TERMINE SECCION DE NOTICIAS Y TEMAS -->
...
<style>
    ...
    .fondo-editado {
        background-image: url("https://cdn.hipwallpaper.com/i/80/42/vmI2Tw.png");
